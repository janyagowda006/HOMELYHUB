...
const protect = async (req, res, next) => {
  try {
    ...
    const decoded = jwt.verify(
      token,
      process.env.JWT_SECRET || "homelyhub-default-jwt-secret-key-2026"
    );
...
// 10. RESTRICT TO - role-based access control (used by bookingRouter and admin routes)
...
// Send out handlers. userRoutes.js and bookingRouter.js import them.
export {
  signup,
  login,
  logout,
